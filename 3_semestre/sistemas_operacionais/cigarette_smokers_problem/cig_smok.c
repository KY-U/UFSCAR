/*
* Alunos: Caio Ueda Sampaio    - RA: 802215
*         Daniel Farah         - RA: 417513
*         Vinicius Guimarães   - RA: 802431
...
void smoking() {
  printf("  Brincando de linguagem de fumaça... hehe\n\n");
  sleep(5);
}
...
int main(void) {
  ...
  if (pthread_create(&th_agent_c, NULL, providesTobaccoMatches, NULL) != 0)   {
    strerror_r(errno, err_msg, MAX);
